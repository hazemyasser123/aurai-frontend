...
export const ProductsEmptyState: React.FC<Props> = ({ onRegister, isFiltered = false }) => {
  return (
    <div className="flex flex-col items-center justify-center gap-6 py-12 sm:py-16 max-w-[672px] mx-auto text-center px-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        {isFiltered ? (
          <p className="font-sans font-normal text-sm sm:text-base text-fg-body">No products match your current filters. Try adjusting your search or filters.</p>
        ) : (
